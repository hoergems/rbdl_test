...
m(1, 0) = 0; 
m(1, 1) = 0; 
m(2, 0) = (1 + pow(0.5*cos(1.0*x[1]) + 0.28, 2)/((-pow(0.5*cos(1.0*x[1]) + 0.28, 2)/(1.0*cos(1.0*x[1]) + 1.56) + 0.28)*(1.0*cos(1.0*x[1]) + 1.56)))/(1.0*cos(1.0*x[1]) + 1.56); 
m(2, 1) = -(0.5*cos(1.0*x[1]) + 0.28)/((-pow(0.5*cos(1.0*x[1]) + 0.28, 2)/(1.0*cos(1.0*x[1]) + 1.56) + 0.28)*(1.0*cos(1.0*x[1]) + 1.56)); 
m(3, 0) = -(0.5*cos(1.0*x[1]) + 0.28)/((-pow(0.5*cos(1.0*x[1]) + 0.28, 2)/(1.0*cos(1.0*x[1]) + 1.56) + 0.28)*(1.0*cos(1.0*x[1]) + 1.56)); 
m(3, 1) = 1.0/(-pow(0.5*cos(1.0*x[1]) + 0.28, 2)/(1.0*cos(1.0*x[1]) + 1.56) + 0.28); 
return m; 
